...
class acf_field_custom_groups extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-group', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-group', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
	...
	*/
	...
	{
		// Note: This function can be removed if not used
		wp_register_script( 'acf-field-group', $this->settings['dir'] . 'js/field-group.js', array('acf-field-group'), $this->settings['version']);
